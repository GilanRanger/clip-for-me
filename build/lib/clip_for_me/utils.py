...
def download_video(url, output_file, output_path="", timestamp_str, clip):
    ...
    seconds, description = parse_time_and_description(
        timestamp_str, clip.clip_delimiter
    )
    ...
    opts = {
        ...
        "start_time": seconds - clip.clip_offset,
        "end_time": seconds - clip.clip_offset + clip.clip_length
    }
