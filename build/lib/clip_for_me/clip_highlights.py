...
class ClipHighlights:
    ...
    def make_clips_from_film(self, output_path, film_filename, tournament_path, game_name, timestamps):
        ...
        for timestamp_str in timestamps:
            ...
            download_video(game_url, film_file, output_path=game_path, timestamp_str, self)
                ...
                for game_link, timestamps in games.items():
                    ...
                    if traversal_type == TraversalType.CLIP_HIGHLIGHTS or save_storage:
                        ...
                        if os.path.exists(full_film_path):
                            ...
                            self.make_clips_from_film(game_path, film_file, tournament_path, game_name, timestamps)
                        else:
                            print(
